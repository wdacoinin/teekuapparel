...
$this->title = 'SKU Di Order Bulan ini';
...
$columns = [
    ...
    [
        ...
        'filterWidgetOptions' => ([       
          ...
          'pluginEvents' => [
            "apply.daterangepicker" => "function() { apply_filter('mo') }",
          ],
        ])
    ],
    [
        'label'=>'User', 
        'value'=>function ($model, $key, $index, $widget) { //diffrent controller
            $mu = BackendUser::findOne($model->user);
            return $mu->nama;
...
echo DynaGrid::widget([
    ...
    'gridOptions'=>[
        ...
        'toolbar' =>  [
            ['content'=>
                //'<a class="btn btn-sm btn-primary modalButton" value="'.Url::to(['sku/create']).'"><i class="fas fa-plus"></i> Input SKU</a>  ' .
