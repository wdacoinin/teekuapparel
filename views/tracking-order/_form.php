...
elseif(Yii::$app->user->identity->divisi == 5){
    $where = 'penjualan.akun > 0 AND penjualan.sales = "'.Yii::$app->user->identity->id.'" AND penjualan_produk_step.end IS NULL'; //marketing
}
elseif(Yii::$app->user->identity->divisi == 8){
    $where = 'penjualan.akun > 0 AND penjualan_produk_step.divisi = 5 AND penjualan_produk_step.end IS NOT NULL'; //proofing
...
/* }elseif(Yii::$app->user->identity->divisi == 12){
    $where = "penjualan.akun > 0 AND penjualan_produk_step.divisi NOT IN ('12')"; */ // poliflex
}elseif(Yii::$app->user->identity->divisi == 12){
    $where = "penjualan.akun > 0 AND penjualan_produk_step.divisi = 5 AND penjualan_produk_step.end IS NOT NULL"; // poliflex
    ...
    $where = 'penjualan.akun > 0 AND penjualan_produk_step.divisi = 17 AND penjualan_produk_step.end IS NOT NULL'; // j atas
}elseif(Yii::$app->user->identity->divisi == 13){
    $where = "penjualan.akun > 0 AND  (penjualan_produk_step.divisi=14 OR penjualan_produk_step.divisi=15) AND penjualan_produk_step.end IS NOT NULL"; //QC
    ...
    $where = "penjualan.akun > 0 AND penjualan_produk_step.divisi = 16 AND penjualan_produk_step.end IS NOT NULL"; //dilivery
}
