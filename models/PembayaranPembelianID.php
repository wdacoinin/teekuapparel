...
use app\models\PembayaranPembelianv;

/**
 * PembayaranPenjualan represents the model behind the search form of `app\models\PembayaranPembelianv`.
 */
class PembayaranPembelianID extends PembayaranPembelianv
{
    /**
     * {@inheritdoc}
     */
     ...
     */
    public function search($params, $pembelian)
    {
        $query = PembayaranPembelianv::find()->where(['idref' => $pembelian]);
