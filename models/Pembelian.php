...
/**
 * Pembelian represents the model behind the search form of `app\models\PembelianT`.
 */
class Pembelian extends PembelianT
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = PembelianT::find()->orderBy(['pembelian_tgl' => SORT_DESC]);
